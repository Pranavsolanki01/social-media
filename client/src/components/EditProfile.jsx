...
const EditProfile = () => {
   ...
   return (<>
    <div className='fixed z-50 inset-0 overflow-y-auto'>
        <div className='flex item-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0'>
